...
export namespace ComputersTypes {
...
export type HTTPMethod =
  ...
  export type QuerySdk = {
      /** undefined **/
  computer: InContextSdkMethod<Query['computer'], QuerycomputerArgs, MeshContext>
  };
  ...
  export type Context = {
      ["Computers"]: { Query: QuerySdk, Mutation: MutationSdk, Subscription: SubscriptionSdk },
