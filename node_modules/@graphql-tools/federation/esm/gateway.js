import { buildASTSchema, concatAST, Kind, parse, visit, } from 'graphql';
...
import { filterInternalFieldsAndTypes, getArgsFromKeysForFederation, getKeyForFederation, } from './utils.js';
...
export function getSubschemaForFederationWithTypeDefs(typeDefs) {
    ...
    subschemaConfig.schema = buildASTSchema(concatAST([parse(`union _Entity = ${entityTypes.join(' | ')}` + SubgraphBaseSDL), parsedSDL]), {
        assumeValidSDL: true,
        assumeValid: true,
    });
