    ...
    return (0, json_machete_1.visitJSONSchema)(schema, {
        ...
        leave(subSchemaAndTypeComposers, { path }) {
            ...
            if (subSchemaAndTypeComposers.oneOf && !subSchemaAndTypeComposers.properties) {
                const isPlural = subSchemaAndTypeComposers.oneOf.some(({ output }) => output instanceof graphql_compose_1.ListComposer);
                if (isPlural) {
                    const { input, output, flatten } = (0, getUnionTypeComposers_js_1.getUnionTypeComposers)({
                        schemaComposer,
                    ...
                    return {
                        ...
                        output: output instanceof graphql_compose_1.ListComposer
                            ? output
                            ...
                            if (!existingInputField) {
                                ...
                                */
                                ...
                                const newInputFieldUnwrappedTC = typeof newInputField.type?.getUnwrappedTC === 'function'
                                    ...
                                    : undefined;
                                if (existingInputFieldUnwrappedTC instanceof graphql_compose_1.InputTypeComposer &&
                                    newInputFieldUnwrappedTC instanceof graphql_compose_1.InputTypeComposer) {
                            ...
                            if (!existingField) {
                                ...
                                */
                                ...
                                const newFieldUnwrappedTC = typeof newField.type?.getUnwrappedTC === 'function'
                                    ...
                                    : undefined;
                                if (existingFieldUnwrappedTC instanceof graphql_compose_1.ObjectTypeComposer &&
                                    newFieldUnwrappedTC instanceof graphql_compose_1.ObjectTypeComposer) {
                    ...
                    if (subSchemaAndTypeComposers.properties) {
                        for (const propertyName in subSchemaAndTypeComposers.properties) {
                            ...
                            if (subSchemaAndTypeComposers.properties[propertyName].flatten) {
                                schemaComposer.addDirective(directives_js_1.FlattenDirective);
                                fieldDirectives.push({
                                    name: 'flatten',
                                });
                            }
        ...
        for (const [newFieldKey, newFieldValue] of Object.entries(newInputTypeComposerFields)) {
            ...
            if (!existingFieldValue) {
                ...
                const newFieldUnwrappedTC = typeof newFieldValue.type.getUnwrappedTC === 'function'
                    ...
                    : undefined;
                if (existingFieldUnwrappedTC instanceof graphql_compose_1.InputTypeComposer &&
                    newFieldUnwrappedTC instanceof graphql_compose_1.InputTypeComposer) {
