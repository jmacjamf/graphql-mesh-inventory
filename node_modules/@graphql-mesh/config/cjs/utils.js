...
exports.hashSHA256 = exports.resolveLogger = exports.resolveDocuments = exports.resolvePubSub = exports.resolveCache = exports.resolveCustomFetch = exports.resolveAdditionalTypeDefs = exports.getPackage = void 0;
...
async function getPackage({ name, type, importFn, cwd, additionalPrefixes = [], }) {
    ...
    for (const moduleName of possibleModules) {
        try {
            ...
            const relativeModuleName = cross_helpers_1.path.isAbsolute(moduleName) ? name : moduleName;
            return {
...
async function resolveCustomFetch({ fetchConfig, importFn, cwd, cache, additionalPackagePrefixes, }) {
    ...
    const processedModuleName = cross_helpers_1.path.isAbsolute(moduleName)
        ? moduleName
        : cross_helpers_1.path.join('..', moduleName);
