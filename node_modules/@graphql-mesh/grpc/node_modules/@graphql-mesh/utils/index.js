...
const getReqResMapByContext = utils.memoize1((context) => {
    return new Map();
});
...
const createDefaultMeshFetch = utils.memoize1(function createDefaultMeshFetch(cache) {
    return useHttpDetailsFetch(useDeduplicateRequestsFetch(fetchache.fetchFactory({
        cache,
        fetch: fetch.fetch,
...
exports.createDefaultMeshFetch = createDefaultMeshFetch;
...
exports.httpDetailsByContext = httpDetailsByContext;
...
exports.pushHttpDetails = pushHttpDetails;
...
exports.useDeduplicateRequestsFetch = useDeduplicateRequestsFetch;
exports.useHttpDetailsFetch = useHttpDetailsFetch;
